...
joblib.dump(x_scaler, "scalerX2_G0.pkl")
joblib.dump(y_scaler, "scalerY2_G0.pkl")
...
checkpoint_cb = keras.callbacks.ModelCheckpoint(
    filepath="checkpoint_G0.best.weights.h5",
    monitor="val_loss",
    save_best_only=True,
...
# ======================================================
model.load_weights("checkpoint_G0.best.weights.h5")
...
plt.title("Loss G0 (MSE – spazio scalato)")
plt.xlabel("Epoche")
...
plt.title("MAE G0 (spazio scalato)")
plt.xlabel("Epoche")
...
plt.title("P reale vs P predetta – G0")
plt.grid(True)
plt.tight_layout()
plt.show()
